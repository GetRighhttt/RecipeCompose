...
/** Android's Room representation; the shared recipe model remains storage-agnostic. */
...
internal fun RandomMeal.toEntity() = RandomMealEntity(
    id = id, idMeal = idMeal, strMeal = strMeal, strCategory = strCategory, strArea = strArea,
    strInstructions = strInstructions, strMealThumb = strMealThumb, strYoutube = strYoutube,
